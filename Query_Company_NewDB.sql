...
select e.name as employee_name, d.department_name as department_name from employees e, departments d where e.department_id = d.department_id or e.department_id is null;


List Projects and Their Department Locations
Write a query to list all projects with their department's location.
select p.project_name, d.location from projects p, departments d where p.department_id = d.department_id;
...
select p.project_name, d.department_name from projects p, departments d where p.department_id = d.department_id or p.department_id is null;
