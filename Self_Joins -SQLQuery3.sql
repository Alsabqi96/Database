...
select e1.name as employee_name, e2.name as colleague_name, e1.hire_date 
from employees e1 
...
select e1.name as employee_name, e2.name as colleague_name, e1.salary, e1.department_id 
from employees e1 
inner join employees e2 
on e1.department_id = e2.department_id 
